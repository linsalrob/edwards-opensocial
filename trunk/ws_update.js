...
// Incompatible with current version of prototype
//SOAP.Envelope.prototype = (new SOAP.Element()).extend({
// Extend the SOAP Element for compatibility with prototype 1.4+
Object.extend(SOAP.Envelope.prototype, SOAP.Element.prototype);
// Extend the current SOAP interface
Object.extend(SOAP.Envelope.prototype,{
  initialize : function() {
...
// Extend the SOAP Element for compatibility with prototype 1.4+
Object.extend(SOAP.Header.prototype, SOAP.Element.prototype);
//Extend the current SOAP interface
...
// Extend the SOAP Element for compatibility with prototype 1.4+
Object.extend(SOAP.Body.prototype, SOAP.Element.prototype);
// Extend the current SOAP interface
Object.extend(SOAP.Body.prototype,{
  initialize : function(element) {
    this.initialize_internal(element);
  },
  set_value : function() {},
